					...
					<div class="p-l-25 p-r-30 p-lr-0-lg">
						<div class="wrap-slick3 flex-sb flex-w">
							...
							<div class="slick3 gallery-lb">
								<div class="item-slick3" data-thumb="images/product-detail-01.j">
									<div class="wrap-pic-w pos-relative">
										<img src="../adminpanel/img/<?php echo $row[4]?>" alt="<?php echo $row[4]?>">
							...
							<div class="flex-w flex-r-m p-b-10">
								<div class="size-204 flex-w flex-m respon6-next">
									...
									<input type="hidden" name="pId" value="<?php echo $row[0]?>">
										<input type="hidden" name="pName" value="<?php echo $row[1]?>">
										<input type="hidden" name="pPrice" value="<?php echo $row[2]?>">
										<input type="hidden" name="pImage" value="<?php echo $row[4]?>">
